...
class Profile:
    def __init__(self, name: str, email: str, skills: [str], jobs: [Job], about: str, picture: str):
        self.name = name
        self.email = email
        self.skills = skills
        self.jobs = jobs
    ...
    def reprJSON(self):
        return dict(name=self.name, email=self.email, skills=self.skills, jobs=self.jobs, about=self.about, picture=self.picture)
